...
const RosterArea = () => {
  // Sample shifts data
  const [shifts, setShifts] = useState(CareGiverShifts);
                        ...
                        {dayShifts.length === 0 ? (
                          ...
                          dayShifts.map((shift) => (
                            ...
                            >
                              ...
                              <div className={`px-1 py-0.5 rounded text-xs inline-block ${getStatusColor(shift.status)}`}>
                                {editingRow === shift.id ? (
                                  <select
                                    value={editingStatus}
                              ...
                              <div>
                                {editingRow === shift.id ? (
                                  <button
                                    className="bg-green-500 text-white px-2 py-1 mt-3 rounded-sm"
                                    onClick={handleDone}
                                  >
                                    Done
                                  </button>
                                  ...
                                  <button
                                    className="bg-black text-white px-2 py-1 mt-3 rounded-sm"
